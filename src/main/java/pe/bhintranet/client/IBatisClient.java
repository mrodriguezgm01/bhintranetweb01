...
public class IBatisClient {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println(" ");
			// load spring beans
			ApplicationContext ctx = new ClassPathXmlApplicationContext("bhintranet-model-data.xml");
			...
			System.out.println("BEFORE: " + service.selectByPrimaryKey(idAfiliado).getNombres());
